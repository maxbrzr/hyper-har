...
class Config:
    ...
    pda_prefix: str = "16_pda_support_prototypes_loso"
    oftta_prefix: str = "18_oftta_support_loso"
    logistic_prefix: str = "20_logistic_linear_head_support_loso"
        ...
        records.append(
            {
                ...
                "method_key": spec.key,
                "method": spec.label,
                "stage_dir": "" if stage_dir is None else str(stage_dir),
                "n": int(row["k"]),
